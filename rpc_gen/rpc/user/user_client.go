...
func (c *clientImpl) CheckUser(ctx context.Context, Req *user.CheckUserRequest, callOptions ...callopt.Option) (r *user.CheckUserResponse, err error) {
	return c.kitexClient.CheckUser(ctx, Req, callOptions...)
}
