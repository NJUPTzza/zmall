...
// Enum value maps for PaymentEvent.
var (
	PaymentEvent_name = map[int32]string{
		0: "PAY",
		1: "PAY_SUCCESS",
		2: "PAY_FAIL",
		3: "REQUEST_REFUND",
	...
	PaymentEvent_value = map[string]int32{
		"PAY":            0,
		"PAY_SUCCESS":    1,
		"PAY_FAIL":       2,
		"REQUEST_REFUND": 3,
...
func (x PaymentEvent) Enum() *PaymentEvent {
	p := new(PaymentEvent)
	*p = x
	return p
}
...
func (PaymentEvent) Descriptor() protoreflect.EnumDescriptor {
	return file_payment_proto_enumTypes[1].Descriptor()
}

func (PaymentEvent) Type() protoreflect.EnumType {
	return &file_payment_proto_enumTypes[1]
}

func (x PaymentEvent) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PaymentEvent.Descriptor instead.
func (PaymentEvent) EnumDescriptor() ([]byte, []int) {
...
type Payment struct {
	...
	Amount     float32       `protobuf:"fixed32,4,opt,name=amount,proto3" json:"amount,omitempty"`                 // 支付金额
...
func (x *Payment) GetPayChannel() string {
	if x != nil {
		return x.PayChannel
	}
	return ""
...
type ProcessPaymentRequest struct {
	...
	PayChannel string  `protobuf:"bytes,4,opt,name=pay_channel,json=payChannel,proto3" json:"pay_channel,omitempty"` // 支付渠道，如 "wechat"、"alipay"
}
...
type UpdatePaymentStatusRequest struct {
	...
	PaymentId int64        `protobuf:"varint,1,opt,name=payment_id,json=paymentId,proto3" json:"payment_id,omitempty"`  // 支付ID
	Event     PaymentEvent `protobuf:"varint,2,opt,name=event,proto3,enum=payment.PaymentEvent" json:"event,omitempty"` // 触发的支付事件
}
...
func (x *UpdatePaymentStatusRequest) GetEvent() PaymentEvent {
	if x != nil {
		return x.Event
	}
	return PaymentEvent_PAY
}
...
type UpdatePaymentStatusResponse struct {
	...
	CommonResponse *CommonResponse `protobuf:"bytes,1,opt,name=commonResponse,proto3" json:"commonResponse,omitempty"`
	Payment        *Payment        `protobuf:"bytes,2,opt,name=payment,proto3" json:"payment,omitempty"` // 更新后的支付信息
}
...
func (x *UpdatePaymentStatusResponse) GetCommonResponse() *CommonResponse {
	if x != nil {
		return x.CommonResponse
	}
	return nil
...
func (x *PaymentMQEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PaymentMQEvent) ProtoMessage() {}

func (x *PaymentMQEvent) ProtoReflect() protoreflect.Message {
	mi := &file_payment_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PaymentMQEvent.ProtoReflect.Descriptor instead.
func (*PaymentMQEvent) Descriptor() ([]byte, []int) {
	return file_payment_proto_rawDescGZIP(), []int{7}
}

func (x *PaymentMQEvent) GetPaymentId() int64 {
	if x != nil {
		return x.PaymentId
	}
	return 0
...
func (x *PaymentMQEvent) GetOrderId() int64 {
	if x != nil {
		return x.OrderId
	}
	return 0
...
func (x *PaymentMQEvent) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *PaymentMQEvent) GetAmount() float32 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *PaymentMQEvent) GetStatus() PaymentStatus {
	if x != nil {
		return x.Status
	}
	return PaymentStatus_UNKNOWN
...
var file_payment_proto_rawDesc = []byte{
	...
	0x07, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0xb6, 0x01, 0x0a, 0x07, 0x50, 0x61, 0x79,
	...
	0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x70, 0x61, 0x79, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65,
	0x6c, 0x12, 0x2e, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28,
	...
	0x73, 0x22, 0x84, 0x01, 0x0a, 0x15, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x50, 0x61, 0x79,
	...
	0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x70, 0x61, 0x79, 0x5f, 0x63,
	0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x70, 0x61,
	0x79, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x22, 0x9e, 0x01, 0x0a, 0x16, 0x50, 0x72, 0x6f,
	0x63, 0x65, 0x73, 0x73, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x3f, 0x0a, 0x0e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x70, 0x61,
	0x79, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70,
	...
	0x12, 0x17, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x06, 0x70, 0x61, 0x79, 0x55, 0x72, 0x6c, 0x22, 0x38, 0x0a, 0x17, 0x47, 0x65, 0x74,
	...
	0x74, 0x49, 0x64, 0x22, 0x87, 0x01, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x50, 0x61, 0x79, 0x6d, 0x65,
	0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x3f, 0x0a, 0x0e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x70, 0x61, 0x79, 0x6d, 0x65,
	...
	0x65, 0x12, 0x2a, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x10, 0x2e, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x50, 0x61, 0x79,
	0x6d, 0x65, 0x6e, 0x74, 0x52, 0x07, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0x68, 0x0a,
	...
	,
	...
	0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x70, 0x61, 0x79, 0x6d,
	0x65, 0x6e, 0x74, 0x2e, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x07, 0x70, 0x61, 0x79,
	0x6d, 0x65, 0x6e, 0x74, 0x22, 0xab, 0x01, 0x0a, 0x0e, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74,
	0x4d, 0x51, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x61, 0x79, 0x6d, 0x65,
	...
	0x6e, 0x74, 0x12, 0x2e, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x05, 0x20, 0x01,
	...
	0x75, 0x73, 0x22, 0x3e, 0x0a, 0x0e, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x2a, 0x4d, 0x0a, 0x0d, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x61,
	...
	,
	...
	0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x23, 0x2e, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e,
	0x74, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x53,
...
var file_payment_proto_goTypes = []interface{}{
	...
	(PaymentEvent)(0),                   // 1: payment.PaymentEvent
	...
	(*PaymentMQEvent)(nil),              // 9: payment.PaymentMQEvent
	(*CommonResponse)(nil),              // 10: payment.CommonResponse
}
var file_payment_proto_depIdxs = []int32{
	0,  // 0: payment.Payment.status:type_name -> payment.PaymentStatus
	10, // 1: payment.ProcessPaymentResponse.commonResponse:type_name -> payment.CommonResponse
	2,  // 2: payment.ProcessPaymentResponse.payment:type_name -> payment.Payment
	10, // 3: payment.GetPaymentStatusResponse.commonResponse:type_name -> payment.CommonResponse
	2,  // 4: payment.GetPaymentStatusResponse.payment:type_name -> payment.Payment
	1,  // 5: payment.UpdatePaymentStatusRequest.event:type_name -> payment.PaymentEvent
	10, // 6: payment.UpdatePaymentStatusResponse.commonResponse:type_name -> payment.CommonResponse
	2,  // 7: payment.UpdatePaymentStatusResponse.payment:type_name -> payment.Payment
	0,  // 8: payment.PaymentMQEvent.status:type_name -> payment.PaymentStatus
	3,  // 9: payment.PaymentService.ProcessPayment:input_type -> payment.ProcessPaymentRequest
	5,  // 10: payment.PaymentService.GetPaymentStatus:input_type -> payment.GetPaymentStatusRequest
	7,  // 11: payment.PaymentService.UpdatePaymentStatus:input_type -> payment.UpdatePaymentStatusRequest
	4,  // 12: payment.PaymentService.ProcessPayment:output_type -> payment.ProcessPaymentResponse
	6,  // 13: payment.PaymentService.GetPaymentStatus:output_type -> payment.GetPaymentStatusResponse
	8,  // 14: payment.PaymentService.UpdatePaymentStatus:output_type -> payment.UpdatePaymentStatusResponse
...
type PaymentService interface {
	...
	UpdatePaymentStatus(ctx context.Context, req *UpdatePaymentStatusRequest) (res *UpdatePaymentStatusResponse, err error)
}
