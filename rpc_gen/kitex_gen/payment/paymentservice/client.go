...
func (p *kPaymentServiceClient) ProcessPayment(ctx context.Context, Req *payment.ProcessPaymentRequest, callOptions ...callopt.Option) (r *payment.ProcessPaymentResponse, err error) {
