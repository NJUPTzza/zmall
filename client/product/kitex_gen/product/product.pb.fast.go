...
func (x *AddProductResp) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	x.Id, offset, err = fastpb.ReadUint32(buf, _type)
	return offset, err
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_OnlineProductResp[number], err)
}

func (x *OnlineProductResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	var v CommonResp
	offset, err = fastpb.ReadMessage(buf, _type, &v)
	if err != nil {
		return offset, err
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_OfflineProductResp[number], err)
}

func (x *OfflineProductResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	var v CommonResp
	offset, err = fastpb.ReadMessage(buf, _type, &v)
	if err != nil {
		return offset, err
...
func (x *GetCategoriesResp) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	var v Category
	offset, err = fastpb.ReadMessage(buf, _type, &v)
	if err != nil {
		return offset, err
...
func (x *GetCategoryResp) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	var v Category
	offset, err = fastpb.ReadMessage(buf, _type, &v)
	if err != nil {
		return offset, err
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_DecrStockResp[number], err)
}

func (x *DecrStockResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	var v CommonResp
	offset, err = fastpb.ReadMessage(buf, _type, &v)
	if err != nil {
		return offset, err
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_IncrStockResp[number], err)
}

func (x *IncrStockResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	var v CommonResp
	offset, err = fastpb.ReadMessage(buf, _type, &v)
	if err != nil {
		return offset, err
...
func (x *AddProductResp) fastWriteField2(buf []byte) (offset int) {
	if x.Id == 0 {
		return offset
	}
	offset += fastpb.WriteUint32(buf[offset:], 2, x.GetId())
	return offset
}
...
func (x *OnlineProductResp) fastWriteField1(buf []byte) (offset int) {
	if x.CommonResp == nil {
		return offset
	}
	offset += fastpb.WriteMessage(buf[offset:], 1, x.GetCommonResp())
...
func (x *OfflineProductResp) fastWriteField1(buf []byte) (offset int) {
	if x.CommonResp == nil {
		return offset
	}
	offset += fastpb.WriteMessage(buf[offset:], 1, x.GetCommonResp())
...
func (x *SearchProductsResp) fastWriteField2(buf []byte) (offset int) {
	...
	for i := range x.GetResults() {
		offset += fastpb.WriteMessage(buf[offset:], 2, x.GetResults()[i])
	}
	return offset
}
...
func (x *GetCategoriesResp) fastWriteField2(buf []byte) (offset int) {
	if x.Categories == nil {
		return offset
	}
	for i := range x.GetCategories() {
		offset += fastpb.WriteMessage(buf[offset:], 2, x.GetCategories()[i])
	}
	return offset
}
...
func (x *GetCategoryResp) fastWriteField2(buf []byte) (offset int) {
	if x.Category == nil {
		return offset
	}
	offset += fastpb.WriteMessage(buf[offset:], 2, x.GetCategory())
	return offset
}
...
func (x *DecrStockResp) fastWriteField1(buf []byte) (offset int) {
	if x.CommonResp == nil {
		return offset
	}
	offset += fastpb.WriteMessage(buf[offset:], 1, x.GetCommonResp())
...
func (x *IncrStockResp) fastWriteField1(buf []byte) (offset int) {
	if x.CommonResp == nil {
		return offset
	}
	offset += fastpb.WriteMessage(buf[offset:], 1, x.GetCommonResp())
...
func (x *AddProductResp) sizeField2() (n int) {
	if x.Id == 0 {
		return n
	}
	n += fastpb.SizeUint32(2, x.GetId())
	return n
}
...
func (x *OnlineProductResp) sizeField1() (n int) {
	if x.CommonResp == nil {
		return n
	}
	n += fastpb.SizeMessage(1, x.GetCommonResp())
...
func (x *OfflineProductResp) sizeField1() (n int) {
	if x.CommonResp == nil {
		return n
	}
	n += fastpb.SizeMessage(1, x.GetCommonResp())
...
func (x *SearchProductsResp) sizeField2() (n int) {
	...
	for i := range x.GetResults() {
		n += fastpb.SizeMessage(2, x.GetResults()[i])
	}
	return n
}
...
func (x *GetCategoriesResp) sizeField2() (n int) {
	if x.Categories == nil {
		return n
	}
	for i := range x.GetCategories() {
		n += fastpb.SizeMessage(2, x.GetCategories()[i])
	}
	return n
}
...
func (x *GetCategoryResp) sizeField2() (n int) {
	if x.Category == nil {
		return n
	}
	n += fastpb.SizeMessage(2, x.GetCategory())
	return n
}
...
func (x *DecrStockResp) sizeField1() (n int) {
	if x.CommonResp == nil {
		return n
	}
	n += fastpb.SizeMessage(1, x.GetCommonResp())
...
func (x *IncrStockResp) sizeField1() (n int) {
	if x.CommonResp == nil {
		return n
	}
	n += fastpb.SizeMessage(1, x.GetCommonResp())
